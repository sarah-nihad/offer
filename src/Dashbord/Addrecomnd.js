...
class Addrecomnd extends Component {
    constructor(props){
        super(props);
    this.state={
      data:[],
...
<Row  style={{marginRight:'0px'}} className="justify-content-md-center"> 
 <Col id="tt" >
  ...
  <Row  style={{marginRight:'0px'}} className="justify-content-md-center"> 
 <Col id="tt" >
  <div id='account'>Add recommended</div></Col> </Row> 
 <div id="form">
